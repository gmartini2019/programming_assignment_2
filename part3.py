...
def compute():
    ...
    """
    data_matrix = dataset['X']
    Z = linkage(data_matrix, method='single')
    ...
    answers["3F: rich get richer"] = "The dendrogram does not strongly illustrate the 'rich get richer' phenomenon, as most clusters merge at different dissimilarity levels. However, there is a slight indication of chaining in the orange cluster, which may suggest a milder version of this phenomenon."
